(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/overlay'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@angular/material/button'), require('@angular/material/select'), require('@angular/material/input'), require('@angular/material/tabs'), require('moment-timezone'), require('rxjs'), require('rxjs/operators'), require('moment'), require('@angular/cdk/portal')) :
    typeof define === 'function' && define.amd ? define('ngx-daterangepicker-material', ['exports', '@angular/cdk/overlay', '@angular/common', '@angular/core', '@angular/forms', '@angular/material/button', '@angular/material/select', '@angular/material/input', '@angular/material/tabs', 'moment-timezone', 'rxjs', 'rxjs/operators', 'moment', '@angular/cdk/portal'], factory) :
    (global = global || self, factory(global['ngx-daterangepicker-material'] = {}, global.ng.cdk.overlay, global.ng.common, global.ng.core, global.ng.forms, global.ng.material.button, global.ng.material.select, global.ng.material.input, global.ng.material.tabs, global._moment$1, global.rxjs, global.rxjs.operators, global.moment, global.ng.cdk.portal));
}(this, (function (exports, overlay, common, core, forms, button, select, input, tabs, _moment$1, rxjs, operators, _moment, portal) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DaterangepickerComponent = /** @class */ (function () {
        ...
        DaterangepickerComponent.prototype.setToNow = function (time) {
            if (time === 'start') {
                this.timepickerVariables.left.selectedHour = this.timePicker24Hour ? moment$1().format('hh') : moment$1().format('HH');
                this.timepickerVariables.left.selectedMinute = moment$1().format('mm');
                this.timepickerVariables.left.selectedSecond = moment$1().format('ss');
                this.setStartDate(this._getDateWithTime(moment$1(), this.sideEnum.left));
            }
            else if (time === 'end') {
                this.timepickerVariables.right.selectedHour = this.timePicker24Hour ? moment$1().format('hh') : moment$1().format('HH');
                this.timepickerVariables.right.selectedMinute = moment$1().format('mm');
                this.timepickerVariables.right.selectedSecond = moment$1().format('ss');
        ...
        DaterangepickerComponent.prototype.scrollUpdate = function (event, type, link, side) {
            ...
            event.srcElement.value = moment$1(value, type).format(type);
            this.timepickerVariables[side][link] = moment$1(value, type).format(type);
        ...
        DaterangepickerComponent.prototype.renderTimePicker = function (side) {
            ...
            this.timepickerVariables[side].selectedHour = moment$1(selected.hour(), this.timePicker24Hour ? 'H' : 'h').format(this.timePicker24Hour ? 'HH' : 'hh');
            this.timepickerVariables[side].selectedMinute = moment$1(selected.minute(), 'm').format('mm');
            this.timepickerVariables[side].selectedSecond = moment$1(selected.second(), 's').format('ss');
            // generate AM/PM
        ...
        DaterangepickerComponent.prototype.preventInput = function (event, type) {
            ...
            this._timeout = setTimeout(function () {
                if (moment$1(event.srcElement.value, type).isValid()) {
                    console.log('valid', event.srcElement.value);
                    event.srcElement.value = moment$1(event.srcElement.value, type).format(type);
                }
                else {
                    console.log('invalid', event.srcElement.value);
                    event.srcElement.value = moment$1(0, type).format(type);
                }
            }, 500);
        };
        /**
    ...
    var TimePipe = /** @class */ (function () {
        ...
        TimePipe.prototype.transform = function (value, type, is24h) {
            if (is24h) {
                type = 'HH';
            }
